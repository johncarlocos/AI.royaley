...
Collects sharp odds from Pinnacle via RapidAPI (DataMenu provider).
Pinnacle is the sharpest sportsbook - their closing lines are the benchmark for CLV calculation.

Features:
- Real-time Pinnacle odds (spreads, moneylines, totals)
...
# Pinnacle sport ID mapping
# Based on RapidAPI Pinnacle Odds API documentation
PINNACLE_SPORT_IDS = {
    "NFL": 15,           # American Football - NFL
    "NCAAF": 880,        # American Football - NCAA
    "CFL": 1928,         # American Football - CFL
    "NBA": 4,            # Basketball - NBA
    "NCAAB": 493,        # Basketball - NCAA
    "WNBA": 578,         # Basketball - WNBA
    "NHL": 19,           # Ice Hockey - NHL
    "MLB": 3,            # Baseball - MLB
    "ATP": 33,           # Tennis - ATP
    "WTA": 34,           # Tennis - WTA
}
...
PINNACLE_SPORT_CODES = {v: k for k, v in PINNACLE_SPORT_IDS.items()}

# League IDs for specific leagues (optional filtering)
PINNACLE_LEAGUE_IDS = {
    "NFL": [889],
    "NCAAF": [880],
    "CFL": [1928],
